...
func englisgHandler(writer http.ResponseWriter, request *http.Request) {
...
func interectHandler(writer http.ResponseWriter, request *http.Request) {
...
func createHandler(writer http.ResponseWriter, request *http.Request) {
	...
	err = file.Close()
	errorCheck(err)
	http.Redirect(writer, request, "/interect", http.StatusFound)
}

func main() {
	http.HandleFunc("/hello", englisgHandler)
	http.HandleFunc("/hola", spanishHandler)
	http.HandleFunc("/interect", interectHandler)
